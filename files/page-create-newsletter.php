                ...
                <div class="ui-tabs ui-widget ui-widget-content ui-corner-all" id="tabs">
                    ...
                    <div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="tabs-1">
                        ...
                        <div class="newsletter-templates">
                            ...
                            ?>
                            <a href="<?php echo $this->plugin_url . 'files/templates/'.basename($template['dir']);?>/preview_big.jpg"  class="template<?php echo ( $newsletter_data['template'] == $template['name'] ) ? ' selected':'';?>" rel="<?php echo $template['name'];?>" title="<?php echo $template['name'];?>">
                                <div style="height:94px;">
                                    <img  src="<?php echo $this->plugin_url . 'files/templates/'.basename($template['dir']);?>/preview.jpg" border="0" alt="template preview">
                                </div>
                        ...
                        <div class="preview-template">
                            <p>
                                <img id="largeImg" src="<?php echo $this->plugin_url . 'files/templates/'.basename( $newsletter_data['template'] );?>/preview_big.jpg" alt="<?php echo $template['name'];?>">
                            </p>
                        </div>
