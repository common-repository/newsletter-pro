...
?>
    ...
    <div class="wrap">
        ...
        <br clear="all"/>
<div class="newsletterpro" align="left">Increase the number of your subscribers or members fast and easy with our quality <a href="http://mailing-list.co/" target="_blank">email list packages</a> available at <a href="http://mailing-list.co/" target="_blank">www.mailing-list.co</a>
<ul>
<li>1) USA Consumer Email List = 115 Million Records - <a href="http://mailing-list.co/product/usa-consumer-email-list-115-million-records/" target="_blank">Open in New Window</a></li>
<li>2) New US Business Email List Database = 12 Million Records - <a href="http://mailing-list.co/product/new-us-business-email-list-database-12-million-records/" target="_blank">Open in New Window</a></li>
<li>3) UK Consumer Email List = 1 Million Full Records - <a href="http://mailing-list.co/product/uk-consumer-email-list-1-million-full-records/" target="_blank">Open in New Window</a></li>
<li>4) View more available <a href="http://mailing-list.co/" target="_blank">packages.</a></li>
</ul>
</div><br/>
        ...
        <br clear="all"/>
<div class="update-nag">Looking for professional search engine optimization company? Checkout the <a href="http://www.sudacademy.org/" target="_blank">Sud Academy official website</a> to outrank any keyword in any competition fast and easy, <a href="http://www.sudacademy.org" target="_blank">learn more!</a></div><br/>
