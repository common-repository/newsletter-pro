<?php
    ...
    $page_title =  __( 'Settings of Newsletter Pro plugin', 'email-newsletter' );

    if ( ! $settings ) {
        $page_title =  __( 'Install Settings of Newsletter Pro plugin', 'email-newsletter' );
...
?>
    ...
    <div class="wrap">
        ...
        <form method="post" action="" name="settings_form" id="settings_form" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <img class="tooltip_img" src="<?php echo $this->plugin_url . "files/images/"; ?>info_small.png" title="<?php echo _e( "The SMTP method allows you to use your SMTP server (or Gmail, Yahoo, Hotmail etc. ) for sending newsletters and emails. It's usually the best choice, especially if your host has restrictions on sending email and to help you to avoid being blacklisted as a SPAM sender.", 'email-newsletter' );?>"/>
                                        </label>
                                        &nbsp;&nbsp;&nbsp;
                                        <label>
                                            ...
                                            <img class="tooltip_img" src="<?php echo $this->plugin_url . "files/images/"; ?>info_small.png" title="<?php echo _e( "This method uses php functions for sending newsletters and emails. Be careful because some hosts may set restrictions on using this method. If you can't edit settings of your server, we recommend to use the SMTP method for optimal results!", 'email-newsletter' );?>"/>
                                        </label>
                                    </td>
                                </tr>
                            </tbody>
            ...
            <?php } else { ?>
<p><font size="4"><font color="red">Important:</font> Edit the above settings if required and click the button below to open the Dashboard of Newsletter PRO.</font></p>

                <input type="button" name="save" value="<?php _e( 'Save and Continue to the Newsletter PRO Dashboard', 'email-newsletter' ) ?>" />
            <?php } ?>
