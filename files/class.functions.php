...
class Email_Newsletter_functions {
    ...
    function load_template( $name ) {
        ...
        if ( !$path ) {
            $path = $this->plugin_dir . "files/$name";
        }
...
//            $this->load_template( 'page-unsubscribe.php' );
            require_once( $this->plugin_dir . "files/page-unsubscribe.php" );
            exit;
        }
    }
    ...
    function get_templates(){
        $template_dirs = glob( $this->plugin_dir . "files/templates/*" );
        $templates = array();
    ...
    function get_uploads(){
        $upload_files = glob( $this->plugin_dir . "files/uploads/*" );
        $uploads = '<option value="">' . __( 'Select an image', 'email-newsletter' ) . '</option>';
        foreach( $upload_files as $upload_file ) {
            $uploads .='<option value="' . $this->plugin_url . 'files/uploads/' . basename( $upload_file ) . '"> ' . basename( $upload_file ) . ' </option>';
        }
        return $uploads;
    }
    ...
    function my_tinymce_plugins( $plugin_array ) {
        $plugin_array['autolink']           = $this->plugin_url . 'files/js/tiny_mce/plugins/autolink/editor_plugin.js';
        $plugin_array['lists']              = $this->plugin_url . 'files/js/tiny_mce/plugins/lists/editor_plugin.js';
        $plugin_array['table']              = $this->plugin_url . 'files/js/tiny_mce/plugins/table/editor_plugin.js';
        $plugin_array['advhr']              = $this->plugin_url . 'files/js/tiny_mce/plugins/advhr/editor_plugin.js';
        $plugin_array['advlink']            = $this->plugin_url . 'files/js/tiny_mce/plugins/advlink/editor_plugin.js';
        $plugin_array['iespell']            = $this->plugin_url . 'files/js/tiny_mce/plugins/iespell/editor_plugin.js';
        $plugin_array['inlinepopups']       = $this->plugin_url . 'files/js/tiny_mce/plugins/inlinepopups/editor_plugin.js';
        $plugin_array['contextmenu']        = $this->plugin_url . 'files/js/tiny_mce/plugins/contextmenu/editor_plugin.js';
        $plugin_array['paste']              = $this->plugin_url . 'files/js/tiny_mce/plugins/paste/editor_plugin.js';
        $plugin_array['fullscreen']         = $this->plugin_url . 'files/js/tiny_mce/plugins/fullscreen/editor_plugin.js';
        $plugin_array['noneditable']        = $this->plugin_url . 'files/js/tiny_mce/plugins/noneditable/editor_plugin.js';
        $plugin_array['visualchars']        = $this->plugin_url . 'files/js/tiny_mce/plugins/visualchars/editor_plugin.js';
        $plugin_array['nonbreaking']        = $this->plugin_url . 'files/js/tiny_mce/plugins/nonbreaking/editor_plugin.js';
        $plugin_array['wordcount']          = $this->plugin_url . 'files/js/tiny_mce/plugins/wordcount/editor_plugin.js';
       ...
       ?>
        <style type="text/css">
            ...
            #toplevel_page_newsletters-dashboard div.wp-menu-image {
                background: url("<?php echo $this->plugin_url; ?>files/images/icon.png") no-repeat scroll 0px 0px transparent;
            }

            #toplevel_page_newsletters-dashboard:hover div.wp-menu-image {
                background: url("<?php echo $this->plugin_url; ?>files/images/icon.png") no-repeat scroll 0px -32px transparent;
            }
