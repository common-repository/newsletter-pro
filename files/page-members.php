...
?>
    ...
    <div class="wrap">
        ...
        <p><?php _e( 'At this page you can add or remove members from groups.', 'email-newsletter' ) ?></p><div class="update-nag">Looking for quality email list packages that you can import in Newsletter PRO?, Checkout our newest packs, visit <a href="http://www.mailing-list.co/" target="_blank">www.mailing-list.co</a> for more details.</div><br/>
